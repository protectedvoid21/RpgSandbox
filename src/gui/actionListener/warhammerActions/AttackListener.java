...
public class AttackListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        roundManager.getActions().doAction(ATTACK,roundManager.getGameObjectWithTurn().getCreature(),roundManager.getBoard().getPlace(point).getGameObject().getCreature(),popUp);
