...
public class ClickedLabelFactory extends LabelFactory {
    private AbstractCustomLabel helpCreatedMethod(AbstractCustomLabel label){
        ...
        label.setBackground(new Color(0x9BEC82));
        uiHelper.setAdditionaldColor(new Color(0x1A3D10), ICustomUI.Index.FIRST);
    ...
    public  AbstractCustomLabel createIconPropLabel(String path){
        ...
        label.getCustomUI().getMargin().remove();
        return label;
    }
